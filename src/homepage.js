     ...
     <div className="insta_codepen_wrap">
        <section className="insta__header insta__acc_menu">
          <div id="insta__acc_menu-panel">
            <img
              alt="Instagram"
              className="insta__acc_menu_logo"
            ...
            <div className="insta__acc_menu_search">
              <svg
                aria-label="Поиск"
                className="insta__acc_menu_search_icon"
                color="#8e8e8e"
                fill="#8e8e8e"
                height="16"
                role="img"
        ...
        <div>
            ...
            <section className="insta__header insta__post_header">
              <div className="insta__icon-wrap insta__post_icon-wrap">
                <img
                  src="http://via.placeholder.com/24"
                  className="insta__mini_icon insta__post_icon"
                  alt="icon"
                />
              </div>
              <span className="insta__post_text-bold"></span>
            </section>
            <section className="insta__post_photos">
              <img
                src="http://via.placeholder.com/620"
                className="insta__post_photo"
                alt="photo"
              />
            </section>
